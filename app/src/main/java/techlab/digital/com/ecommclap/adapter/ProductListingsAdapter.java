...
public class ProductListingsAdapter
    ...
    /*Interface to handle to addproduct button*/
    ...
    /*Interface to add or repaet the product based on the user choice*/
    ...
    /*Interface to take action on Book service Button*/
